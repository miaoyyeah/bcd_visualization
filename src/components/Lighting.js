...
const Lighting = ({ isCollapsed }) => (
  <section id="lighting" className={`section ${isCollapsed ? 'collapsed' : 'expanded'}`}>
    ...
    <div className="image-container">
      ...
      <p className="image-caption">Figure 1. Floor Plan of the Lighting Installation - Intelligent Workplace (CMU).</p>
    </div>
    ...
    <div className="image-container">
      ...
      <p className="image-caption">Figure 2. Floor Plan of the Lighting Circulation - Intelligent Workplace (CMU).</p>
    </div>
