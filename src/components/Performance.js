...
const Performance = ({isCollapsed}) => (
    ...
    <div>
      ...
      <p className="image-caption">Figure 10. Indoor vs Outdoor Temperature 2018 - Intelligent Workplace (CMU).</p>
    </div>

    <div className="image-container">
      <img src={co2} alt="CO₂ Readings 2018" />
      <p className="image-caption">Figure 11. CO₂ Readings 2018 - Intelligent Workplace (CMU).</p>
    </div>
    </div>
    </section>
);
